...
Gem::Specification.new do |s|
  ...
  s.files = ["Rakefile", "Releases", "TODO", "README", "LICENSE", "setup.rb", "lib/daemons.rb", "lib/daemons/application.rb", "lib/daemons/application_group.rb", "lib/daemons/change_privilege.rb", "lib/daemons/cmdline.rb", "lib/daemons/controller.rb", "lib/daemons/daemonize.rb", "lib/daemons/etc_extension.rb", "lib/daemons/exceptions.rb", "lib/daemons/monitor.rb", "lib/daemons/pid.rb", "lib/daemons/pidfile.rb", "lib/daemons/pidmem.rb", "examples/run/ctrl_crash.rb", "examples/run/ctrl_exec.rb", "examples/run/ctrl_exit.rb", "examples/run/ctrl_hanging.rb", "examples/run/ctrl_keep_pid_files.rb", "examples/run/ctrl_monitor.rb", "examples/run/ctrl_multiple.rb", "examples/run/ctrl_normal.rb", "examples/run/ctrl_ontop.rb", "examples/run/ctrl_optionparser.rb", "examples/run/ctrl_proc.rb", "examples/run/ctrl_proc_multiple.rb", "examples/run/ctrl_proc_simple.rb", "examples/run/ctrl_slowstop.rb", "examples/run/myserver.rb", "examples/run/myserver_crashing.rb", "examples/run/myserver_exiting.rb", "examples/run/myserver_hanging.rb", "examples/run/myserver_slowstop.rb", "examples/call/call.rb", "examples/call/call_monitor.rb", "examples/daemonize/daemonize.rb"]
